        ...
        <div class="flex gap-x-4">
            <div>
                ...
                <button class="border-2 border-[#00D41C] px-1.5 add-to-order
                        {{ $recommendedItem['score1'] ? 'hidden' : '' }}"
                        data-item-code="{{ $recommendedItem['item_code'] }}"">
            ...
            <div class="flex items-center ml-auto">
                ...
                <input type="text" name="volume" value="{{ $recommendedItem['unorderedVolume'] }}"
