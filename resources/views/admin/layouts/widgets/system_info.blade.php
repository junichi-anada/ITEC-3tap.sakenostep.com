...
<div class="border-t-8 border-[#F4CF41] border-l border-r border-b py-4">
    <div class="px-4 flex flex-col gap-y-4">
        <div>
            <h2 class="font-bold pb-2 border-b text-2xl">お知らせ</h2>
        </div>
        <!-- お知らせ内容 -->
        <div class="flex flex-col gap-y-6 overflow-y-scroll h-[calc(100vh-13.5rem)] px-5">
            <div class="flex items-start gap-x-10 border-b border-b-[#a6a6a6]  pb-6">
                <p class="font-bold">2024.11.01</p>
                <div class="flex flex-col gap-y-6">
                    <p>【システムからのお知らせ】</p>
                    <p class="leading-8">本日からシステムが運用開始となりました。お気づきの点がございましたら、お気軽にお問合せください。</p>
                </div>
            </div>
        </div>
    </div>
