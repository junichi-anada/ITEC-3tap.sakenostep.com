...
// 更新確認モーダルの表示
export function makeOrderUpdateConfirmModal() {
    modalTitle.textContent = "注文情報更新の確認";
...
// 更新成功モーダルの表示
export function makeOrderUpdateSuccessModal() {
    modalTitle.textContent = "更新完了";
    modalBody.textContent = "注文情報の更新が完了しました。";
...
// 更新失敗モーダルの表示
export function makeOrderUpdateFailModal(
